...
namespace EntityFrameworkLayer.Entities
{
    ...
    public class BaseEntity : INotifyPropertyChanged
    {
        ...
        /// </summary>
        public BaseEntity()
            : this(EntityState.Unchanged, false, true, false)
        {
        }
        ...
        /// Initialisation des propriétés de la classe.
        /// </summary>
        public BaseEntity(EntityState state, bool isReadOnly, bool isEnabled, bool isChangeStateActivated)
        {
            _state = state;
        ...
        protected virtual bool SetField<T>(ref T field, T value, [CallerMemberName] string propertyName = null)
        {
            ...
            if (IsChangeStateActivated && !new[] { EntityState.Added, EntityState.Deleted }.Contains(State))
